"""
Django settings for friend_zones_39518 project.
...
ROOT_URLCONF = 'friend_zones_39518.urls'
...
WSGI_APPLICATION = 'friend_zones_39518.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "friend_zones_39518 API",
    "DESCRIPTION": "API documentation for friend_zones_39518 App",
    "VERSION": "v1",
}
